  ...
  return (
    <div>
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2">
        ...
        >
          <SelectTrigger className={`${pillCls} w-[120px]`}>
        ...
        <div className="flex items-center gap-1.5">
          <div className="relative">
            ...
            <Input
              ...
              className={`${pillCls} ${noSpinner} w-24 pl-6`}
            />
          </div>
        ...
        {resultsText && (
          <span className="ml-auto font-bold text-xs uppercase tracking-[0.15em] text-primary">
            {resultsText}
          </span>
        )}
      </div>
